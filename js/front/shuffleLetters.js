(function($){'use strict';$.fn.shuffleLetters=function(prop){var options=$.extend({"step":8,"fps":25,"text":"","callback":function(){}},prop)
return this.each(function(){var el=$(this),str="";if(el.data('animated')){return true;}
el.data('animated',true);if(options.text){str=options.text.split('');}else{str=el.text().split('');}
...
var container=$(".slider-content h2.typed_active");container.shuffleLetters();function shuffle(text){container.shuffleLetters({text:text});}
var i=0;if(jQuery(".typed_active").length){var interval=setInterval(function(){shuffle(arr[i++%arr.length]);},4000);}})(jQuery);